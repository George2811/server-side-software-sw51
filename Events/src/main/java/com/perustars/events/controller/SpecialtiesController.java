...
import com.perustars.events.resource.SaveSpecialityResource;
...
public class SpecialtiesController {
    ...
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "All Specialties returned", content = @Content(mediaType = "application/json"))
    })
