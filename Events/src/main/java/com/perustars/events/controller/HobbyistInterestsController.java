...
public class HobbyistInterestsController {
    ...
    @Operation(summary = "Post Hobbyist Association", description = "Associate a Hobbyist with an Specialty", tags = {"hobbyist"})
    @ApiResponses(value = {
    ...
    @Operation(summary = "Delete Hobbyist Association", description = "Disassociate a Hobbyist with an Specialty", tags = {"hobbyist"})
    @ApiResponses(value = {
