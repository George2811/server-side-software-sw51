...
public class ArtistsController {
    ...
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "All Artists returned", content = @Content(mediaType = "application/json"))
    })
    @GetMapping("/artists")
    ...
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "Artist returned", content = @Content(mediaType = "application/json"))
    })
    ...
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "Artist created", content = @Content(mediaType = "application/json"))
    })
    @PostMapping("/artists")
    ...
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "Artist deleted", content = @Content(mediaType = "application/json"))
    })
    ...
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "Artists by brand name returned", content = @Content(mediaType = "application/json"))
    })
