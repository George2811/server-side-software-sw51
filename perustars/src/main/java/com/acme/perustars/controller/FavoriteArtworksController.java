...
public class FavoriteArtworksController {
    ...
    @Operation(summary = "Post Hobbyist Association", description = "Associate a Hobbyist with an Artwork", tags = {
            "hobbyist"})
    @ApiResponses(value = {
    ...
    @Operation(summary = "Delete Hobbyist Association", description = "Disassociate a Hobbyist with an Artwork",
            tags = {"hobbyist"})
    @ApiResponses(value = {
